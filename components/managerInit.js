...
// import MeasurementService from '../../utils/cornerstone3D/services/serviceUtil/MeasurementService';
// import DisplaySetService from '../../utils/cornerstone3D/services/serviceUtil/DisplaySetService';

// import { CommandsManager } from '../../utils/cornerstone3D/services/classes';
// import { ExtensionManager } from '../../utils/cornerstone3D/extensions';
// import { ServicesManager } from '../../utils/cornerstone3D/services';
// import { HotkeysManager } from '../../utils/conrnerstone3D/services/classes';
 ...
 * OHIF appInit 참고
 */
async function managerInit(appConfigOrFunc, defaultExtensions, defaultModes) {
  ...
  // OHIF의 App.tsx > appInift.js 흐름을 봐도 appConfig에 주어진 modes 셋팅이 없음. 추후 분석 필요
  // if (!appConfig.modes) {
